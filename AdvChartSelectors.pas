...
type
  ...
  TAdvChartSelectorPanel = class;

  TAdvChartSelectorItem = class(TCollectionItem)
  private
    FItemRect: TRect;
    FCaption: string;
    FEnable: boolean;
  ...
  TAdvChartSelectorItems = class(TCollection)
  private
    FOwner: TPersistent;
    function GetItem(Index: Integer): TAdvChartSelectorItem;
    procedure SetItem(Index: Integer; const Value: TAdvChartSelectorItem);
  protected
    function GetOwner: TPersistent; override;
  public
    constructor Create(AOwner: TPersistent);
    function Add: TAdvChartSelectorItem;
    function Insert(Index: Integer): TAdvChartSelectorItem;
    property Items[Index: Integer]: TAdvChartSelectorItem read GetItem write SetItem; default;
  end;
  ...
  TAdvChartCustomSelectorPanel = class(TCustomPanel)
  private
    FOwner: TComponent;
    FColorTo: TColor;
  ...
  TSelectEvent = procedure(Sender: TObject; Index: Integer; Item: TAdvChartSelectorItem) of object;

  TAdvChartSelectorPanel = class(TAdvChartCustomSelectorPanel)
  private
    FItemIndex: integer;
    FItems: TAdvChartSelectorItems;
    FColorHotTo: TColor;
    FBorderColor: TColor;
    ...
    procedure SetItems(const Value: TAdvChartSelectorItems);
  ...
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    property Items: TAdvChartSelectorItems read FItems write SetItems;
  ...
  TAdvChartColorCubePanel = class(TAdvChartCustomSelectorPanel)
  private
  ...
  TAdvChartColorSpectrumPanel = class(TAdvChartCustomSelectorPanel)
  private
  ...
  TAdvChartTableSelectorPanel = class(TAdvChartCustomSelectorPanel)
  private
    FOnSelect: TNotifyEvent;
  ...
  private
    FSelectorPanel: TAdvChartCustomSelectorPanel;
  ...
  published
    property SelectorPanel: TAdvChartCustomSelectorPanel read FSelectorPanel write FSelectorPanel;
  end;

  TDrawToolEvent = procedure(Sender: TObject; Canvas: TCanvas; ItemIndex: integer; R: TRect) of object;

  TAdvChartCustomSelectorEx = class(TCustomControl)
  private
    FDropDownWindow: TSelectorDropDownWindow;
    FSelectorPanel: TAdvChartSelectorPanel;
    ...
    procedure SetTools(const Value: TAdvChartSelectorItems);
  ...
  protected
    ...
    property Tools: TAdvChartSelectorItems read FTools write SetTools;
  ...
  {$ENDIF}
  TAdvChartToolSelector = class(TAdvChartCustomSelectorEx)
  private
  protected
  public
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvChartPenStyleSelector = class(TAdvChartCustomSelectorEx)
  private
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvChartPenWidthSelector = class(TAdvChartCustomSelectorEx)
  private
    procedure Initialize;
  protected
    procedure SetSelectorPanel; override;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvChartBrushStyleSelector = class(TAdvChartCustomSelectorEx)
  private
    FSelectionType: TSelectionType;
    procedure Initialize;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvChartShadowSelector = class(TAdvChartCustomSelectorEx)
  private
    procedure Initialize;
  protected
    procedure Loaded; override;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvChartTableBorderSelector = class(TAdvChartCustomSelectorEx)
  private
    procedure Initialize;
  protected
    procedure SetSelectorPanel; override;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvChartGradientDirectionSelector = class(TAdvChartCustomSelectorEx)
  private
    FStartColor: TColor;
    FEndColor: TColor;
  ...
  TAdvChartCustomColorSelector = class(TAdvChartCustomSelectorEx)
  private
    FColorCubePanel: TAdvChartColorCubePanel;
    FSpectrumPanel: TAdvChartColorSpectrumPanel;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvChartTextColorSelector = class(TAdvChartCustomColorSelector)
  protected
    procedure Initialize; override;
  public
  published
  ...
  TAdvChartCustomTableSelector = class(TAdvChartCustomSelectorEx)
  private
    FTableSelectorPanel: TAdvChartTableSelectorPanel;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvChartTableSelector = class(TAdvChartCustomTableSelector)
  protected
  public
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvChartCharacterSelector = class(TAdvChartCustomSelectorEx)
  private
    FOnSelect: TNotifyEvent;
    FCharacters: string;
    FSelectedChar: char;
...
constructor TAdvChartCustomSelectorEx.Create(AOwner: TComponent);
var
  i: integer;
begin
  inherited;
  ...
  FTools := TAdvChartSelectorItems.Create(Self);
  FSelectedIndex := -1;
  FDupSelectedIndex := -1;
...
destructor TAdvChartCustomSelectorEx.Destroy;
begin
  FGlyph.Free;
  FGlyphHot.Free;
  FGlyphDown.Free;
...
procedure TAdvChartCustomSelectorEx.Click;
begin
  inherited Click;
end;
...
procedure TAdvChartCustomSelectorEx.CMFontChanged(var Message: TMessage);
begin
  Invalidate;
end;
...
procedure TAdvChartCustomSelectorEx.CMMouseEnter(var Message: TMessage);
begin
  inherited;
...
procedure TAdvChartCustomSelectorEx.CMMouseLeave(var Message: TMessage);
begin
  inherited;
...
procedure TAdvChartCustomSelectorEx.CMTextChanged(var Message: TMessage);
begin
  Invalidate;
end;
...
procedure TAdvChartCustomSelectorEx.Loaded;
begin
  inherited Loaded;
...
procedure TAdvChartCustomSelectorEx.MouseDown(Button: TMouseButton;
...
procedure TAdvChartCustomSelectorEx.MouseMove(Shift: TShiftState; X, Y: Integer);
begin
...
procedure TAdvChartCustomSelectorEx.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TAdvChartCustomSelectorEx.Notification(AComponent: TComponent;
...
function TAdvChartCustomSelectorEx.DrawGlyph(aGlyph: TBitMap; aRect: TRect): integer;
var
  aP: TPoint;
begin
  Result := 0;
...
procedure TAdvChartCustomSelectorEx.DrawGlyphAndCaption(aGlyph: TBitmap;
  R: TRect);
var
  CapR: TRect;
  tbmp: TBitmap;
...
procedure TAdvChartCustomSelectorEx.DrawButton;
var
...
function TAdvChartCustomSelectorEx.DoVisualStyles: Boolean;
begin
  if FIsThemed then
...
procedure TAdvChartCustomSelectorEx.DrawComboButton;
var
  R, R2, BtnR, CapR: TRect;
  AP: TPoint;
...
procedure TAdvChartCustomSelectorEx.Paint;
begin
  if Style in [ssButton {, ssCheck}] then
  begin
...
procedure TAdvChartCustomSelectorEx.SetAutoThemeAdapt(const Value: Boolean);
begin
...
procedure TAdvChartCustomSelectorEx.ThemeAdapt;
var
...
procedure TAdvChartCustomSelectorEx.WndProc(var Message: TMessage);
begin
...
procedure TAdvChartCustomSelectorEx.SetAllowAllUp(const Value: Boolean);
begin
...
procedure TAdvChartCustomSelectorEx.SetBorderColor(const Value: TColor);
begin
  FBorderColor := Value;
  Invalidate;
end;
...
procedure TAdvChartCustomSelectorEx.SetColorChecked(const Value: TColor);
begin
  FColorChecked := Value;
  Invalidate;
end;
...
procedure TAdvChartCustomSelectorEx.SetColorCheckedTo(const Value: TColor);
begin
...
procedure TAdvChartCustomSelectorEx.SetColorTo(const Value: TColor);
begin
  FColorTo := Value;
  Invalidate;
end;
...
procedure TAdvChartCustomSelectorEx.SetDown(const Value: Boolean);
begin
...
procedure TAdvChartCustomSelectorEx.SetDropDownButton(const Value: Boolean);
begin
...
procedure TAdvChartCustomSelectorEx.SetFlat(const Value: Boolean);
begin
  if Value <> FFlat then
  begin
    FFlat := Value;
...
procedure TAdvChartCustomSelectorEx.SetGlyph(const Value: TBitmap);
var
  x, y: Integer;
  PxlColor: TColor;
  c: byte;
...
procedure TAdvChartCustomSelectorEx.SetGlyphDisabled(const Value: TBitmap);
begin
  FGlyphDisabled.Assign(Value);
end;
...
procedure TAdvChartCustomSelectorEx.SetGlyphDown(const Value: TBitmap);
begin
...
procedure TAdvChartCustomSelectorEx.SetGlyphHot(const Value: TBitmap);
begin
...
procedure TAdvChartCustomSelectorEx.SetImages(const Value: TCustomImageList);
begin
...
procedure TAdvChartCustomSelectorEx.SetShaded(const Value: Boolean);
begin
  FShaded := Value;
...
procedure TAdvChartCustomSelectorEx.SetStyle(const Value: TAdvSelectorStyle);
begin
  FStyle := Value;
...
procedure TAdvChartCustomSelectorEx.SetGroupIndex(const Value: Integer);
begin
...
procedure TAdvChartCustomSelectorEx.GlyphChanged(Sender: TObject);
begin
  Invalidate;
end;
...
procedure TAdvChartCustomSelectorEx.SetAppearanceStyle(
...
procedure TAdvChartCustomSelectorEx.ButtonDown;
begin
...
procedure TAdvChartCustomSelectorEx.DoDropDown;
var
  R: TRect;
  P: TPoint;
begin
...
procedure TAdvChartCustomSelectorEx.HideDropDown;
begin
  FDropDownWindow.Visible := false;
end;
...
procedure TAdvChartCustomSelectorEx.PopupBtnDown;
begin
  DoDropDown;
end;
...
procedure TAdvChartCustomSelectorEx.SetColorDropDown(const Value: TColor);
begin
...
procedure TAdvChartCustomSelectorEx.SetColorDropDownTo(const Value: TColor);
begin
...
procedure TAdvChartCustomSelectorEx.SetSelectorPanelItems;
var
  i: integer;
begin
...
procedure TAdvChartCustomSelectorEx.SetSelectorPanel;
begin
  if not assigned(FSelectorPanel) and assigned(FDropDownWindow) then
  begin
    FSelectorPanel := TAdvChartSelectorPanel.Create(FDropDownWindow);
...
procedure TAdvChartCustomSelectorEx.SetDropDownCount(const Value: integer);
begin
...
procedure TAdvChartCustomSelectorEx.SetTGradientDirection(
...
procedure TAdvChartCustomSelectorEx.OnDropDownWindowHide(Sender: TObject);
begin
  State := absUp;
  Invalidate;
end;
...
function TAdvChartCustomSelectorEx.GetCaption: string;
begin
...
procedure TAdvChartCustomSelectorEx.SetCaption(const Value: string);
begin
...
procedure TAdvChartCustomSelectorEx.OnDropDownPanelShouldHide(Sender: TObject);
begin
  HideDropDown;
end;
...
function TAdvChartCustomSelectorEx.GetSelectedIndex: integer;
begin
...
procedure TAdvChartCustomSelectorEx.SetSelectedIndex(const Value: integer);
begin
...
procedure TAdvChartCustomSelectorEx.SetTools(const Value: TAdvChartSelectorItems);
begin
  FTools := Value;
end;
...
procedure TAdvChartCustomSelectorEx.OnDropDownPanelSelect(Sender: TObject);
begin
...
procedure TAdvChartCustomSelectorEx.SetButtonsPerRow(const Value: TNoOfButtons);
begin
...
procedure TAdvChartCustomSelectorEx.OnDropDownPanelHotTool(Sender: TObject;
...
procedure TAdvChartCustomSelectorEx.OnToolSelect;
begin
  if Assigned(FOnSelect) then
    FOnSelect(Self, FSelectorPanel.ItemIndex, Tools[FSelectorPanel.ItemIndex]);
end;
...
procedure TAdvChartCustomSelectorEx.OnDropDownPanelDrawTool(Sender: TObject;
...
function TAdvChartCustomSelectorEx.GetVersionNr: Integer;
begin
...
function TAdvChartCustomSelectorEx.GetVersion: string;
var
  vn: Integer;
begin
  vn := GetVersionNr;
...
procedure TAdvChartCustomSelectorEx.SetVersion(const Value: string);
begin
...
procedure TAdvChartCustomSelectorEx.KeyDown(var Key: Word; Shift: TShiftState);
begin
  inherited;
  if (Key = VK_F2) then
    DoDropDown;
...
procedure TAdvChartCustomSelectorEx.ShowDropDown;
begin
  DoDropDown;
end;
...
procedure TAdvChartCustomSelectorEx.SetTwoColorImages(const Value: Boolean);
begin
...
procedure TAdvChartCustomSelectorEx.ChangeImagesColor(ForeGColor,
  BkGColor: TColor);
var
  I: Integer;
  bmp: TBitMap;
...
procedure TAdvChartCustomSelectorEx.SetForeGroundImageColor(const Value: TColor);
begin
...
procedure TAdvChartCustomSelectorEx.SetStretchImageDraw(const Value: Boolean);
begin
...
{ TAdvChartCustomSelectorPanel }

constructor TAdvChartCustomSelectorPanel.Create(AOwner: TComponent);
begin
  inherited;
  FOwner := AOwner;
  BevelOuter := bvNone;
...
function TAdvChartCustomSelectorPanel.GetVisibleHeight: integer;
begin
  Result := Height;
end;
...
procedure TAdvChartCustomSelectorPanel.MouseMove(Shift: TShiftState; X, Y: Integer);
begin
  inherited;
end;
...
procedure TAdvChartCustomSelectorPanel.Paint;
var
  R: TRect;
begin
  inherited;
...
procedure TAdvChartCustomSelectorPanel.SetColorTo(const Value: TColor);
begin
  FColorTo := Value;
end;
...
procedure TAdvChartCustomSelectorPanel.SetTGradientDirection(
  const Value: TGradientDirection);
begin
  FGradientDirection := Value;
end;
...
procedure TAdvChartCustomSelectorPanel.SetWindowBorderColor(
  const Value: TColor);
begin
...
{ TAdvChartSelectorPanel }

constructor TAdvChartSelectorPanel.Create(AOwner: TComponent);
begin
  inherited;
  FItems := TAdvChartSelectorItems.Create(self);
...
destructor TAdvChartSelectorPanel.Destroy;
begin
  FItems.Free;
  inherited;
end;
...
procedure TAdvChartSelectorPanel.MouseMove(Shift: TShiftState; X, Y: Integer);
var
  i, j: integer;
begin
  inherited;
...
procedure TAdvChartSelectorPanel.DrawItem(Index: integer; RefreshItem: boolean = false);
var
  Gr, R: TRect;
  DTSTYLE: dword;
  bmp: TBitMap;
...
procedure TAdvChartSelectorPanel.Paint;
var
  i: integer;
begin
  inherited;
...
procedure TAdvChartSelectorPanel.SetBorderColor(const Value: TColor);
begin
  FBorderColor := Value;
end;
...
procedure TAdvChartSelectorPanel.SetImages(const Value: TCustomImageList);
begin
  FImages := Value;
end;
...
procedure TAdvChartSelectorPanel.SetItemIndex(const Value: integer);
begin
  if Value < 0 then
  begin
    FItemIndex := -1;
...
procedure TAdvChartSelectorPanel.SetItems(const Value: TAdvChartSelectorItems);
begin
  FItems := Value;
end;
...
function TAdvChartSelectorPanel.TotalAutoSizeButtons: integer;
var
  i: integer;
begin
  Result := 0;
...
procedure TAdvChartSelectorPanel.AutoSizeBtnSize(var W, H: integer);
var
  i: integer;
begin
...
function TAdvChartSelectorPanel.GetMaxWidth: integer;
var
  i, asb, fwb: integer;
begin
...
procedure TAdvChartSelectorPanel.SetItemsPosition;
var
...
procedure TAdvChartSelectorPanel.SetPanelHeight;
begin
...
procedure TAdvChartSelectorPanel.SetButtonsPerRow(const Value: TNoOfButtons);
begin
  FButtonsPerRow := Value;
end;

function TAdvChartSelectorPanel.ItemAtPos(X, Y: integer): integer;
var
  i: integer;
begin
  Result := -1;
...
procedure TAdvChartSelectorPanel.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  i: integer;
begin
  inherited;
...
procedure TAdvChartSelectorPanel.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  FMouseDown := false;
...
procedure TAdvChartSelectorPanel.KeyDown(var Key: Word; Shift: TShiftState);
begin
  inherited;
...
procedure TAdvChartSelectorPanel.WMChar(var Msg: TWMKey);
begin
  inherited;
end;
...
procedure TAdvChartSelectorPanel.CMWantSpecialKey(var Msg: TCMWantSpecialKey);
begin
  inherited;
end;
...
procedure TAdvChartSelectorPanel.SetButtonMargin(const Value: integer);
begin
  FButtonMargin := Value;
end;
...
procedure TAdvChartSelectorPanel.CMMouseLeave(var Message: TMessage);
var
  i: integer;
begin
  inherited;
...
procedure TAdvChartSelectorPanel.SetMinButtonHeight(const Value: integer);
begin
...
procedure TAdvChartSelectorPanel.SetMinButtonWidth(const Value: integer);
begin
...
procedure TAdvChartSelectorPanel.SetTwoColorImages(const Value: Boolean);
begin
  FTwoColorImages := Value;
end;
...
{ TAdvChartSelectorItem }

procedure TAdvChartSelectorItem.Assign(Source: TPersistent);
begin
  if (Source is TAdvChartSelectorItem) then
  begin
    BackGroundColor := (Source as TAdvChartSelectorItem).BackGroundColor;
    Caption := (Source as TAdvChartSelectorItem).Caption;
    CaptionAlignment := (Source as TAdvChartSelectorItem).CaptionAlignment;
    ImageIndex := (Source as TAdvChartSelectorItem).ImageIndex;
    Hint := (Source as TAdvChartSelectorItem).Hint;
    Value := (Source as TAdvChartSelectorItem).Value;
    ItemType := (Source as TAdvChartSelectorItem).ItemType;
    Tag := (Source as TAdvChartSelectorItem).Tag;
  end;

end;

constructor TAdvChartSelectorItem.Create(Collection: TCollection);
begin
  inherited;
  FCaption := '';
  FEnable := true;
...
destructor TAdvChartSelectorItem.Destroy;
begin
...
procedure TAdvChartSelectorItem.SetBackGroundColor(const Value: TColor);
begin
...
procedure TAdvChartSelectorItem.SetCaption(const Value: string);
begin
...
procedure TAdvChartSelectorItem.SetEnable(const Value: boolean);
begin
...
procedure TAdvChartSelectorItem.SetHint(const Value: string);
begin
  FHint := Value;
end;
...
procedure TAdvChartSelectorItem.SetImageIndex(const Value: integer);
begin
...
procedure TAdvChartSelectorItem.SetItemType(const Value: TSelectorItemType);
begin
...
procedure TAdvChartSelectorItem.SetTag(const Value: integer);
begin
  FTag := Value;
end;
...
procedure TAdvChartSelectorItem.SetValue(const Value: string);
begin
...
procedure TAdvChartSelectorItem.SetvCaptionAlignment(const Value: TAlignment);
begin
...
{ TAdvChartSelectorItems }

function TAdvChartSelectorItems.Add: TAdvChartSelectorItem;
begin
  Result := TAdvChartSelectorItem(inherited Add);
end;

//------------------------------------------------------------------------------

constructor TAdvChartSelectorItems.Create(AOwner: TPersistent);
begin
  inherited Create(TAdvChartSelectorItem);
  FOwner := AOwner;
end;

//------------------------------------------------------------------------------

function TAdvChartSelectorItems.GetItem(Index: Integer): TAdvChartSelectorItem;
begin
  Result := TAdvChartSelectorItem(inherited Items[Index]);
end;

//------------------------------------------------------------------------------

function TAdvChartSelectorItems.GetOwner: TPersistent;
begin
  Result := FOwner;
end;
...
function TAdvChartSelectorItems.Insert(Index: Integer): TAdvChartSelectorItem;
begin
  Result := TAdvChartSelectorItem(inherited Insert(Index));
end;

//------------------------------------------------------------------------------

procedure TAdvChartSelectorItems.SetItem(Index: Integer;
  const Value: TAdvChartSelectorItem);
begin
...
{ TAdvChartColorCubePanel }

procedure TAdvChartColorCubePanel.CMMouseLeave(var Message: TMessage);
begin
  inherited;
end;
...
constructor TAdvChartColorCubePanel.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TAdvChartColorCubePanel.Destroy;
begin
  inherited;
end;
...
procedure TAdvChartColorCubePanel.DrawColorCube(Index: integer);
begin
...
procedure TAdvChartColorCubePanel.DrawAllColorCube;
var
  i: integer;
begin
...
procedure TAdvChartColorCubePanel.DrawHexagon(aCanvas: TCanvas; P: TPoint; X, Y: integer);
begin
  P.X := P.X - X;
  P.Y := P.Y - y * 2;
...
function TAdvChartColorCubePanel.IndexOfCellAt(X, Y: integer): integer;
var
  i: integer;
begin
  Result := -1;
...
procedure TAdvChartColorCubePanel.Initialize;
var
  c, r, i, j, cl: integer;
begin
  FCubeSize.X := 6;
...
procedure TAdvChartColorCubePanel.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  i, j: integer;
begin
...
procedure TAdvChartColorCubePanel.MouseMove(Shift: TShiftState; X, Y: Integer);
var
  i, j: integer;
begin
  inherited;
...
procedure TAdvChartColorCubePanel.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TAdvChartColorCubePanel.Paint;
begin
  inherited;
  DrawAllColorCube;
end;
...
function TAdvChartColorCubePanel.PtInCell(Index: integer; P: TPoint): Boolean;
begin
...
procedure TAdvChartColorCubePanel.SetItemsPosition;
begin
  FHotIndex := -1;
  SetPanelSize;
end;
...
procedure TAdvChartColorCubePanel.SetPanelSize;
begin
  Height := 160;
  Width := 182;
end;
...
procedure TAdvChartColorCubePanel.SetSelectedColor(const Value: TColor);
begin
...
procedure TAdvChartColorCubePanel.DrawSelectedBorder;
begin
...
procedure TAdvChartColorCubePanel.DrawHotBorder;
begin
...
procedure TAdvChartColorCubePanel.SetSelectedIndexAndColor(clr: TColor;
  index: integer);
var
  i: integer;
  //OldSelClr: TColor;
...
procedure TAdvChartColorCubePanel.SetShowRGBHint(const Value: Boolean);
begin
  FShowRGBHint := Value;
  ShowHint := Value;
end;
...
{ TAdvChartColorSpectrumPanel }

procedure TAdvChartColorSpectrumPanel.CMMouseLeave(var Message: TMessage);
begin
  inherited;
end;
...
constructor TAdvChartColorSpectrumPanel.Create(AOwner: TComponent);
var
  //frm: TSpectrumForm;
  tbmp: TBitmap;
begin
...
destructor TAdvChartColorSpectrumPanel.Destroy;
begin
  FSpectrumImage.Free;
  inherited;
end;
...
procedure TAdvChartColorSpectrumPanel.DrawFocusPoint;
begin
  {
...
procedure TAdvChartColorSpectrumPanel.DrawHotRect;
begin
  Canvas.Pen.Color := clGray;
  Canvas.Brush.Style := bsClear;
...
procedure TAdvChartColorSpectrumPanel.DrawSelectedRect;
begin
  Canvas.Pen.Color := clGray;
  Canvas.Brush.Style := bsClear;
...
procedure TAdvChartColorSpectrumPanel.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
end;
...
procedure TAdvChartColorSpectrumPanel.MouseMove(Shift: TShiftState; X,
  Y: Integer);
begin
  inherited;
end;
...
procedure TAdvChartColorSpectrumPanel.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  if Assigned(FOnShouldHide) then
...
procedure TAdvChartColorSpectrumPanel.Paint;
begin
  inherited;
  Canvas.Brush.Style := bsClear;
  Canvas.Pen.Color := clwhite;
...
procedure TAdvChartColorSpectrumPanel.SetItemsPosition;
begin
  SetPanelSize;
...
procedure TAdvChartColorSpectrumPanel.SetPanelSize;
begin
  Height := 174;
  Width := 150
end;
...
procedure TAdvChartColorSpectrumPanel.SetSelectedColor(const Value: TColor);
begin
...
procedure TAdvChartColorSpectrumPanel.SpectrumImageMouseDown(Sender: TObject;
...
procedure TAdvChartColorSpectrumPanel.SpectrumImageMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TAdvChartColorSpectrumPanel.SpectrumImageMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
constructor TAdvChartPenStyleSelector.Create(AOwner: TComponent);
begin
  inherited;
  //if not (csDesigning in ComponentState) then
  begin
...
destructor TAdvChartPenStyleSelector.Destroy;
begin
...
procedure TAdvChartPenStyleSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvChartPenStyleSelector.Loaded;
begin
  inherited;
end;
...
procedure TAdvChartPenStyleSelector.SetSelectorPanel;
begin
...
function TAdvChartPenStyleSelector.GetSelectedPenStyle: TPenStyle;
begin
...
procedure TAdvChartPenStyleSelector.SetSelectedPenStyle(const Value: TPenStyle);
begin
...
procedure TAdvChartPenStyleSelector.SetSelectionType(
...
function TAdvChartPenStyleSelector.GetPenColor: TColor;
begin
...
procedure TAdvChartPenStyleSelector.SetPenColor(const Value: TColor);
begin
...
function TAdvChartPenStyleSelector.GetPenStyleAtIndex(
...
function TAdvChartPenStyleSelector.GetIndexOfStyle(
...
constructor TAdvChartBrushStyleSelector.Create(AOwner: TComponent);
begin
  inherited;
  //if not (csDesigning in ComponentState) then
  begin
...
destructor TAdvChartBrushStyleSelector.Destroy;
begin
  //if not (csDesigning in ComponentState) and Assigned(FImages) then
  begin
    FImages.Free;
...
function TAdvChartBrushStyleSelector.GetBrushColor: TColor;
begin
  Result := ForeGroundImageColor;
end;
...
function TAdvChartBrushStyleSelector.GetBrushStyleAtIndex(
...
function TAdvChartBrushStyleSelector.GetIndexOfBrushStyle(
...
function TAdvChartBrushStyleSelector.GetSelectedBrushStyle: TBrushStyle;
begin
...
procedure TAdvChartBrushStyleSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvChartBrushStyleSelector.Loaded;
begin
  inherited;
...
procedure TAdvChartBrushStyleSelector.SetBrushColor(const Value: TColor);
begin
  ForeGroundImageColor := Value;
  Invalidate;
end;
...
procedure TAdvChartBrushStyleSelector.SetSelectedBrushStyle(
...
procedure TAdvChartBrushStyleSelector.SetSelectionType(
  const Value: TSelectionType);
begin
  if FSelectionType <> Value then
  begin
...
procedure TAdvChartBrushStyleSelector.SetSelectorPanel;
begin
  //self.TwoColorImages := True;
  inherited;
  FSelectorPanel.Images := Fimages;
...
constructor TAdvChartShadowSelector.Create(AOwner: TComponent);
begin
  inherited;
  //if not (csDesigning in ComponentState) then
  begin
...
destructor TAdvChartShadowSelector.Destroy;
begin
  //if not (csDesigning in ComponentState) and Assigned(FImages) then
  begin
    FImages.Free;
...
procedure TAdvChartShadowSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvChartShadowSelector.Loaded;
begin
  inherited;
...
procedure TAdvChartShadowSelector.SetSelectorPanel;
begin
  inherited;
  FSelectorPanel.Images := Fimages;
...
constructor TAdvChartTableBorderSelector.Create(AOwner: TComponent);
begin
  inherited;
  //if not (csDesigning in ComponentState) then
  begin
...
destructor TAdvChartTableBorderSelector.Destroy;
begin
  //if not (csDesigning in ComponentState) and Assigned(FImages) then
  begin
    FImages.Free;
...
procedure TAdvChartTableBorderSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvChartTableBorderSelector.SetSelectorPanel;
begin
  inherited;
  FSelectorPanel.Images := Fimages;
...
constructor TAdvChartGradientDirectionSelector.Create(AOwner: TComponent);
begin
  inherited;
{  if not (csDesigning in ComponentState) then
  begin
...
destructor TAdvChartGradientDirectionSelector.Destroy;
begin
 { if not (csDesigning in ComponentState) and Assigned(FImages) then
  begin
    FImages.Free;
...
procedure TAdvChartGradientDirectionSelector.DrawGlyphAndCaption(
...
procedure TAdvChartGradientDirectionSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvChartGradientDirectionSelector.SelectorPanelOnDrawItem(Sender: TObject;
...
procedure TAdvChartGradientDirectionSelector.SetEndColor(const Value: TColor);
begin
  FEndColor := Value;
  Invalidate;
end;
...
procedure TAdvChartGradientDirectionSelector.SetSelectorPanel;
begin
  inherited;
...
procedure TAdvChartGradientDirectionSelector.SetShowSelectedGradient(
  const Value: boolean);
begin
...
procedure TAdvChartGradientDirectionSelector.SetStartColor(const Value: TColor);
begin
  FStartColor := Value;
  Invalidate;
end;
...
{ TAdvChartPenStyleSelector }

constructor TAdvChartPenWidthSelector.Create(AOwner: TComponent);
begin
  inherited;
  //if not (csDesigning in ComponentState) then
  begin
...
destructor TAdvChartPenWidthSelector.Destroy;
begin
  //if not (csDesigning in ComponentState) and Assigned(FImages) then
  begin
    FImages.Free;
...
procedure TAdvChartPenWidthSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvChartPenWidthSelector.SetSelectorPanel;
begin
  inherited;
  FSelectorPanel.Images := Fimages;
  FSelectorPanel.SetItemsPosition;
...
destructor TAdvChartCustomColorSelector.Destroy;
begin
  if not (csDesigning in ComponentState) then
  begin
...
procedure TAdvChartCustomColorSelector.Initialize;
begin
end;

procedure TAdvChartColorSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvChartCustomColorSelector.SetSelectorPanel;
var
  i: integer;
begin
  ...
  begin
    ...
    begin
      FColorCubePanel := TAdvChartColorCubePanel.Create(FDropDownWindow);
  ...
  begin
    ...
    begin
      FSpectrumPanel := TAdvChartColorSpectrumPanel.Create(FDropDownWindow);
...
procedure TAdvChartCustomColorSelector.SetColorSelectionStyle(
...
procedure TAdvChartCustomColorSelector.Loaded;
begin
  inherited;
...
procedure TAdvChartCustomColorSelector.DrawGlyphAndCaption(aGlyph: TBitmap; R: TRect);
var
  CapR: TRect;
  clr: TColor;
begin
...
procedure TAdvChartCustomColorSelector.SelectorPanelOnDrawItem(Sender: TObject; Index: integer;
  R: TRect);
begin
...
procedure TAdvChartCustomColorSelector.SetShowSelectedColor(const Value: Boolean);
begin
...
procedure TAdvChartCustomColorSelector.CubePanelOnSelect(Sender: TObject);
begin
...
procedure TAdvChartCustomColorSelector.SpectrumPanelOnSelect(Sender: TObject);
begin
...
procedure TAdvChartCustomColorSelector.SetSelectedColor(const Value: TColor);
begin
  FSelectedColor := Value;
  Invalidate;
end;
...
function TAdvChartCustomColorSelector.GetSelectedColor: TColor;
begin
...
procedure TAdvChartCustomColorSelector.OnToolSelect;
begin
...
procedure TAdvChartTextColorSelector.Initialize;
begin
  Tools.Clear;
...
{ TAdvChartTableSelectorPanel }

constructor TAdvChartTableSelectorPanel.Create(AOwner: TComponent);
begin
  inherited;
  FColCount := 5;
  FRowCount := 4;
...
destructor TAdvChartTableSelectorPanel.Destroy;
begin
...
procedure TAdvChartTableSelectorPanel.MouseMove(Shift: TShiftState; X,
  Y: Integer);
var
  c, r, ax, ay: integer;
...
procedure TAdvChartTableSelectorPanel.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
...
procedure TAdvChartTableSelectorPanel.DrawLabel;
var
  s: string;
  R: TRect;
begin
...
procedure TAdvChartTableSelectorPanel.DrawAllCells;
var
  c, r, x, y: integer;
begin
  x := FLeftMargin;
...
procedure TAdvChartTableSelectorPanel.Paint;
begin
  inherited;
  DrawAllCells;
  DrawLabel;
...
procedure TAdvChartTableSelectorPanel.SetCellSize(const Value: integer);
begin
  FCellSize := Value;
end;
...
procedure TAdvChartTableSelectorPanel.SetColCount(const Value: integer);
begin
  FColCount := Value;
end;
...
procedure TAdvChartTableSelectorPanel.SetItemsPosition;
begin
  SetPanelSize;
end;
...
procedure TAdvChartTableSelectorPanel.SetPanelSize;
var
  c, r, x, y: integer;
begin
  x := FLeftMargin;
...
procedure TAdvChartTableSelectorPanel.SetRowCount(const Value: integer);
begin
  FRowCount := Value;
end;
...
procedure TAdvChartTableSelectorPanel.SetSelectedCols(const Value: integer);
begin
...
procedure TAdvChartTableSelectorPanel.SetSelectedRows(const Value: integer);
begin
  FSelectedRows := Value;
end;
...
procedure TAdvChartTableSelectorPanel.InvalidateSelection(OldSelectedCols,
...
procedure TAdvChartTableSelectorPanel.CMMouseLeave(var Message: TMessage);
begin
  inherited;
  FSelectedCols := -1;
  FSelectedRows := -1;
...
{ TAdvChartCustomTableSelector }

constructor TAdvChartCustomTableSelector.Create(AOwner: TComponent);
begin
  inherited;
  FDefaultColCount := 5;
  FDefaultRowCount := 4;
...
destructor TAdvChartCustomTableSelector.Destroy;
begin
  if not (csDesigning in ComponentState) then
  begin
...
procedure TAdvChartCustomTableSelector.Loaded;
begin
  inherited;
...
procedure TAdvChartCustomTableSelector.MouseMove(Shift: TShiftState; X,
  Y: Integer);
begin
  inherited;
...
procedure TAdvChartCustomTableSelector.SetDefaultColCount(const Value: integer);
begin
...
procedure TAdvChartCustomTableSelector.SetDefaultRowCount(const Value: integer);
begin
  if (Value > 0) and (Value <= 60) then
...
procedure TAdvChartCustomTableSelector.SetSelectorPanel;
begin
  if not Assigned(FTableSelectorPanel) and Assigned(FDropDownWindow) then
  begin
    FTableSelectorPanel := TAdvChartTableSelectorPanel.Create(FDropDownWindow);
...
procedure TAdvChartCustomTableSelector.TableSelectorOnSelect(Sender: TObject);
begin
...
constructor TAdvChartCharacterSelector.Create(AOwner: TComponent);
begin
  inherited;
  FCharacters := '';
  FSelectedChar := #0;
...
destructor TAdvChartCharacterSelector.Destroy;
begin
  FCharFont.Free;
  inherited;
end;
...
procedure TAdvChartCharacterSelector.AddItemsFromChars;
var
  i: integer;
begin
  Tools.Clear;
...
procedure TAdvChartCharacterSelector.LoadCharFromFont;
var
  i: integer;
begin
  if FAutoLoad then
...
procedure TAdvChartCharacterSelector.Loaded;
begin
  inherited;
end;
...
procedure TAdvChartCharacterSelector.OnToolSelect;
begin
  if SelectedIndex >= 0 then
...
procedure TAdvChartCharacterSelector.SetAutoLoad(const Value: boolean);
begin
...
procedure TAdvChartCharacterSelector.SetCharacters(const Value: string);
begin
  if AutoLoad then
...
procedure TAdvChartCharacterSelector.SetCharFont(const Value: TFont);
begin
...
procedure TAdvChartCharacterSelector.SetSelectedChar(const Value: char);
begin
  FSelectedChar := Value;
  Invalidate;
end;
...
procedure TAdvChartCharacterSelector.SetSelectorPanel;
//var
  //i, j: integer;
begin
{
...
procedure TAdvChartCharacterSelector.DrawGlyphAndCaption(aGlyph: TBitmap;
  R: TRect);
var
  CapR: TRect;
