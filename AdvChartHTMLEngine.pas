...
uses
  Classes, AdvChartGraphics, Types, Graphics,
  AdvChartTypes, AdvChartBitmapContainer, AdvChartGraphicsTypes
  {$IFDEF CMNLIB}
  , ImgList
  {$ENDIF}
  {$IFNDEF LCLWEBLIB}
...
var
  ...
  OldPenKind: TAdvChartGraphicsStrokeKind;
  ...
  blnkKind: TAdvChartGraphicsFillKind;
      ...
      begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        ...
                        begin
                          bmp := TAdvChartBitmap(BitmapContainer.FindBitmap(Prop));
                        end;
                        ...
                        begin
                          Delete(Prop,1,6);
                          bmp := TAdvChartBitmap(TAdvChartBitmap.CreateFromURL(Prop));
                          bmpcreated := true;
                        end;
                        {$ENDIF}
                      ...
                      begin
                        ...
                        begin
                          ...
                          begin
                            {$IFDEF WEBLIB}
                            NewColor := TAdvChartGraphics.TextToColor(LowerCase(prop));
                            {$ENDIF}
                            {$IFNDEF WEBLIB}
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        ...
                        bmp := TAdvChartBitmap.Create;
                        TAdvChartUtils.LoadBitmapFromBase64(Prop, bmp);
                        bmpcreated := true;
                      end;
                    end;
        ...
        'F':begin
              ...
              begin
                ...
                if (TAdvChartUtils.VarPos('STYLE',TagProp,TagPos)>0) then
                begin
                  Prop := Copy(TagProp,TagPos+5,Length(TagProp));
                  Prop := Copy(Prop,Pos('=',Prop)+1,Length(Prop));
                  Prop := Copy(Prop,Pos('"',Prop)+1,Length(Prop));
...
begin
  ...
  if Pos('&',s) > 0 then
  begin
    s :=  TAdvChartUtils.UnFixMarkup(s, true, true);
    repeat
      Foundtag := False;
